...
import com.example.Lab_AND103_PD07016.adapter.FruitAdapter;
import com.example.Lab_AND103_PD07016.databinding.ActivityHomeBinding;
...
//                        httpRequest.callAPI().getPageFruit("Bearer "+token, page).enqueue(getListFruitResponse);
    ...
    private void getData (ArrayList<Fruit> _ds) {
        ...
        if (binding.loadmore.getVisibility() == View.VISIBLE) {
            ...
            binding.rcvFruit.setLayoutManager(gridLayoutManager);
